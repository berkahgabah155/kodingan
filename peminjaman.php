            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        include "koneksi.php";
                        $query_peminjaman = mysqli_query($conn, "SELECT * FROM peminjaman_buku 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <ol>
                                        <?php
                                        $query_detail = mysqli_query($conn, "SELECT * FROM detail_peminjaman_buku d
                                ...
                                <?php
                                $query_cek_kembali = mysqli_query($conn, "SELECT * FROM detail_peminjaman_buku
